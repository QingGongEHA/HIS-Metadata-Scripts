...
file_html = open('D:\MoH Interoperability\HIS Metadata\HMIS-DHIS2\DHIS2 Metadata-splitted\\dashboardItems.html','w') #replace with the path where you want to see the result, replace the file name with what you want to call the result
