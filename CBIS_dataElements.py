...
DHIS_metadata = open('D:\MoH Interoperability\HIS Metadata\CBIS-DHIS2\DHIS2-metadata.json') #replace with the path to the DHIS2 metadata in json format, which is exported from DHIS2
data = json.load(DHIS_metadata)

file_json = open('D:\MoH Interoperability\HIS Metadata\CBIS-DHIS2\CBIS_dataElements_JsonArray.json', 'w') #put the file in the folder where you want to see the result
...
result_data = open('D:\MoH Interoperability\HIS Metadata\CBIS-DHIS2\CBIS_dataElements_JsonArray.json') # Open the JSON file; the file should be the same as in line8
...
file_html = open('D:\MoH Interoperability\HIS Metadata\CBIS-DHIS2\CBIS_dataElements.html','w') #put the file in the folder where you want to see the result
